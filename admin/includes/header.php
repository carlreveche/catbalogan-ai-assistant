...
<title>Admin - Catbalogan AI Assistant</title>
...
<div class="admin-shell">
  ...
  <aside class="admin-sidebar">
    <div class="brand">
      ...
      <div>
        <h1>Admin Panel</h1>
        <p>Catbalogan AI Assistant</p>
      </div>
    </div>

    <nav class="admin-nav">
      <a href="index.php" class="<?= $adminPage === 'index.php' ? 'active' : '' ?>">
      ...
      <a href="reports.php" class="<?= $adminPage === 'reports.php' ? 'active' : '' ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg>
        Reports
      </a>
      <a href="users.php" class="<?= $adminPage === 'users.php' ? 'active' : '' ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        Users
      </a>
      <a href="permits.php" class="<?= $adminPage === 'permits.php' ? 'active' : '' ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 13h6"/><path d="M9 17h4"/></svg>
        Permits
      </a>
      <a href="kb.php" class="<?= $adminPage === 'kb.php' ? 'active' : '' ?>">
      ...
      <a href="feedback.php" class="<?= $adminPage === 'feedback.php' ? 'active' : '' ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
        Feedback
      </a>
      <a href="activity_logs.php" class="<?= $adminPage === 'activity_logs.php' ? 'active' : '' ?>">
    ...
    <div class="admin-sidebar-footer">
      <a href="../chat.php" class="open-chat-btn">
  ...
  <main class="admin-main">
    <?php if ($flash): ?>
      <?php $flashType = ($flash['type'] ?? 'success') === 'error' ? 'danger' : 'success'; ?>
      <div class="alert alert-<?= sanitize($flashType) ?>">
